    ...
    <p>
      <small>
        <span class="text-muted">
          <?=$page->date;?><br />
          <span title="Word Count" data-toggle="tooltip" class="badge badge-default"># <?=$page->words;?></span> <!--&#8226;-->
          <span title="Reading Time (200-150 wpm)" data-toggle="tooltip" class="badge badge-default">&#8987; <?=$page->readTime;?></span>
        </span>
